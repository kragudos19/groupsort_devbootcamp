...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post phases_url, params: { phase: { belongs_to: @phase.belongs_to, phase_num: @phase.phase_num } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { belongs_to: @phase.belongs_to, phase_num: @phase.phase_num } }
