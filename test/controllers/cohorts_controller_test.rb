...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { location: @cohort.location, name: @cohort.name } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { location: @cohort.location, name: @cohort.name } }
